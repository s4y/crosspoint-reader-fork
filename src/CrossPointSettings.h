...
class CrossPointSettings : public PersistableStore<CrossPointSettings> {
 ...
 public:
  ...
  // Quiet Sleep/Wake (0 = off, 1 = on): drop the transitional screens around a
  // sleep cycle — the "Going to sleep" popup on the way down, the boot screen on
  // the way back up. Cold boots still show the boot screen.
  uint8_t quietSleepWake = 0;
